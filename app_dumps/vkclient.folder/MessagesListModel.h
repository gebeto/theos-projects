...
@class NSNumber, MessagesUpdate, NSObject, NSString;
...
-(void)indexUpdate:(id)update remove:(id)remove add:(id)add allowAppend:(BOOL)append pending:(BOOL)pending complete:(id)rcomplete;
