...
@class NSData, VKPrivacySetting, NSURL, VKVideo, PHAsset, NSNumber, AVAssetExportSession, NSString;
...
-(id)withPrivacyView:(id)privacyView privacyComment:(id)comment isPrivate:(BOOL)aPrivate asset:(id)asset video:(id)video albumId:(id)anId;
