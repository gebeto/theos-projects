...
@class InlineFriendsController, UIButton, MBContactPicker, GiftsSendMessageCell, UIView, NSArray, GiftSendItemRenderable, UITableViewCell, GiftsSendModel, NSString;
