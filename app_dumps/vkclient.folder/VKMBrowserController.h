...
@class UIScrollView, NSString, UIWebView, NSMutableArray, VKMBrowserTarget, UILabel, CoalescedPerformer, UIButton, UIToolbar, UIBarButtonItem, LandscapePresenter, TextPageModel;
