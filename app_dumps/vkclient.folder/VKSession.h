...
@class NSURL, NSString, VKMStore, VKPushSettings, NSNumber, VKClient, VKStats, VKGroupState, NotificationsManager, VKConnectivityState, ActivityModel, AdsStatsManager, ExternalAdsStatsManager, VKDB, VKOnlineStore, CommonStatsManager, ViewPostStatsManager, StoreStockManager, StickersRecentModel, VideoUploadManager, NSArray;
