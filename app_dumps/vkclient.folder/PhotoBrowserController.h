...
@class UIScrollView, UITapGestureRecognizer, NSString, NavWindowPresenter, NSArray, PhotoHostView, LayoutAwareView, UIToolbar, UIBarButtonItem, UIButton, Component5HostView, UILabel, UIImageView, PhotoBrowsingModel, UIPanGestureRecognizer;
@protocol VKImage;
