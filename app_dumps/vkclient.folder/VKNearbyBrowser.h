...
@class VKUser, MCNearbyServiceAdvertiser, MCNearbyServiceBrowser, MCPeerID, NSObject, NSString, NSMutableArray;
@protocol VKNearbyBrowserDelegate, OS_dispatch_queue;
