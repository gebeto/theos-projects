...
@class NSMutableArray, NSURL, AVAssetWriterInput, NSObject, NSDictionary, AVAssetWriter, AVAssetWriterInputPixelBufferAdaptor;
@protocol VKGifAVWriterDelegate, OS_dispatch_queue, OS_dispatch_semaphore;
