...
@class RoundedProgressOverlayLayer, UIColor, RoundedProgressOverlayCircle, NSString, UILabel, UIImageView;
@protocol RoundedProgressOverlayViewDelegate;

__attribute__((visibility("hidden")))
@interface RoundedProgressOverlayView : XXUnknownSuperclass <UIGestureRecognizerDelegate, MBProgressHUDCustomView> {
	int _rotationDegree;
