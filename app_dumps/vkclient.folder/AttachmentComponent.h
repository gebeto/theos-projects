...
+(id)mediumPreviewWithPhoto:(id)photo title:(id)title description:(id)description badge:(id)badge;
+(id)detailedPreviewWithPhoto:(id)photo title:(id)title description:(id)description badge:(id)badge;
