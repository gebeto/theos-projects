...
@class NSString, NSMutableArray, NSMutableDictionary, Action;
...
-(void)lookupAttachmentsLimit:(int)limit photoUpload:(id)upload videoUpload:(id)upload3 docUpload:(id)upload4 giftSend:(id)send block:(id)block;
