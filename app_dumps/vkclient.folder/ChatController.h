...
@class WrapAttachmentsLayout, VKSelectorDropdownPresentation, NSString, UIImageView, NSNumber, NSArray, VKMImageButton, Component5HostView, SendingModel, RootView, RecordExtraInputPanelView, NSMutableArray, ScrollToTopDetectionView, NSMutableDictionary, UIButton, LandscapePresenter, UIView, UIBarButtonItem, LayoutAwareView, ChatListModel;
