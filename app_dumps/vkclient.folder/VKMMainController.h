...
@class VKMController, MenuNotificationCell, NSString, NSIndexPath, VKAPNSManager, UINavigationController, UIView, BadgedBarButtonItem, CaptchaPrompt, MainMenuPlayer, NSArray, UserMenuCell, TitleMenuCell, UITableViewCell, HintsSearchDisplayController;
