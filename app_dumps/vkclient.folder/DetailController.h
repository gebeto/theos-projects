...
@class VKHUD, UIActivityIndicatorView, WrapAttachmentsLayout, DetailMoreCell, ExtraInputPanelView, UITapGestureRecognizer, CommentEditContext, UIRefreshControl, DocsSketchUploadEditAttachment, DetailModel, NSString;
