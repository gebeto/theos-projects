...
@class UIPanGestureRecognizer, UIViewController, VideoPlayerFromFullScreenTransitionAnimationController, VKMScrollViewController, NSString;
@protocol VKVideoPlayerHolder, VideoPlayerToFullScreenTransitionDelegate, PanGestureDrivenDismissableTransitionViewController;
