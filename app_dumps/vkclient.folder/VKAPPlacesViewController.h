...
@class CLLocation, TGLocationPinView, VKPPNoAccessView, UIButton, CLLocationManager, VKAPLocationStorage, TGLocationAnnotation, UIView, TGLocationMapView, CLGeocoder, PlacesSearchModel, NSString;
