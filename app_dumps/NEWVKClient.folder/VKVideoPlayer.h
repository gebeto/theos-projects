...
@class AVURLAsset, VKVideoPlayerState, NSURL, NSString, KVOObserver, AVPlayerItem, VideoContainerView, NSObject, NSTimer, AVPlayer;
@protocol VideoPlayStats, OS_dispatch_queue, VKVideoPlayerHolder;
