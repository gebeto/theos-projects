...
@class UIBarButtonItem, UIView, StoryStatContext, NSString, StoryEditorDraggableAttachmentsContainerView, SketchView, UIButton, UIImageView, VKMask, StoryEditorNavigationBar, StickersPickerViewController, TransparentToolbar;
...
@interface StoryEditorPreviewViewController : VKMController <StoryEditorEditableTextAttachmentDelegate, StoryEditorDraggableAttachmentsContainerViewDelegate, StickersPickerViewControllerDelegate> {
	...
	StickersPickerViewController* _stickersPickerController;
}
...
@property(retain, nonatomic) StickersPickerViewController* stickersPickerController;
