...
@class NSURLSessionDataTask, MainModel, VKAudioQueuePlayerItem, NSString, NSMutableDictionary, NSArray, AVQueuePlayer, VKAdAudioPlayer, BackgroundTaskWrapper, UIImage, VKAudioPlayerModel, MTRGInstreamAudioAd, MTRGInstreamAudioAdBanner;
