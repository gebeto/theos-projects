...
@class TextPageModel, UIBarButtonItem, NSString, NSMutableArray, VKMBrowserTarget, UIButton, UIScrollView, UILabel, LandscapePresenter, CoalescedPerformer, UIToolbar, UIWebView;
