...
@class NSString, NSArray, VKRenderedTextSettings, NSAttributedString;
...
@property(retain, nonatomic) NSArray* strikethroughs;
...
-(void)enumerateRectsOfAttributesInRange:(NSRange)range block:(id)block;
