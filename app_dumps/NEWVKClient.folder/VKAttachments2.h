...
@class VKPrettyCards, NSArray, VKIdentity, VKPhotosListAttach;
@protocol VKSource, PrettyCardsStats, SnippetStats, PhotoStats, AudioStats;
...
@interface VKAttachments2 : XXUnknownSuperclass {
	...
	VKPrettyCards* _prettyCards;
	id<VKSource> _signer;
	id<AudioStats> _audioStats;
	id<PhotoStats> _photoStats;
	id<SnippetStats> _snippetStats;
	id<PrettyCardsStats> _prettyCardsStats;
}
@property(retain, nonatomic) id<PrettyCardsStats> prettyCardsStats;
...
@property(retain, nonatomic) VKPrettyCards* prettyCards;
