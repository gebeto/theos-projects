...
@class NSArray, NSString, StoryFullscreenView, KVOObserver, NSTimer;
@protocol StoryFullscreenViewControllerDataSource, StoryFullscreenViewControllerDelegate, StoryFullscreenViewModel, StoryFullscreenViewModelProvider;
