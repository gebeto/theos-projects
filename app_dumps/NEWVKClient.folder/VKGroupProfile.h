...
@class VKLiveVideoSettings, VKList, NSArray, VKVideo, NSString, VKTopic, VKGroup, ProfileCoverInfo, VKPlace, VKAudio, VKWikiPage;
...
@property(retain, nonatomic) NSArray* app_buttons;
