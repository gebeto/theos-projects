...
@class UITapGestureRecognizer, NSString, VKVideo, VideoPlayerModel, AppVolumeIndicatorView, KVOObserver, VKFeedAdsItem, VideoContainerView, NSTimer, VKVideoPlayer, FullScreenVideoPlayerControlsView;
...
@property(retain, nonatomic) VKFeedAdsItem* adsItem;
