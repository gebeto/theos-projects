...
@class NSMutableDictionary, NSArray, NSString, MTRGAdParams, MTRGCustomParams, MTRGInstreamAdSection, NSNumber, MTRGInstreamAdVideoEngine;
@protocol MTRGInstreamAdPlayer, MTRGInstreamAdDelegate;
