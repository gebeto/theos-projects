...
@class NSMutableDictionary, NSString, VKVideo, VKPhoto, NSNumber;
...
-(id)pickStoryVideoFirstFrameVariantForSize:(CGSize)size;
-(id)pickStoryPhotoVariantForSize:(CGSize)size;
-(id)messagesVariant;
-(id)fullVariant;
-(id)thumbnailVariant;
-(id)photoOrVideo;
