...
@class AVAssetReaderAudioMixOutput, AVAssetReaderVideoCompositionOutput, NSArray, NSURL, NSString, AVAssetReader, AVAsset, AVAudioMix, AVVideoComposition, AVAssetWriterInputPixelBufferAdaptor, NSObject, AVAssetWriterInput, NSDictionary, AVAssetWriter, NSError;
