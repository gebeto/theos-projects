...
@class UIView, NSString, VKPPNoAccessView, TGLocationPinView, TGLocationAnnotation, VKAPLocationStorage, CLLocation, CLLocationManager, CLGeocoder, UIButton, TGLocationMapView, PlacesSearchModel;
