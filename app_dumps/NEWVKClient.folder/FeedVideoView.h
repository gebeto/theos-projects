...
@class NSString, NSURL, VKVideo, UIImage, KVOObserver, VideoPlayerErrorOverlayView, UIImageView, NSTimer, VKImageVariant, FinishedVideoActionsOverlayView, VKVideoPlayer, FeedVideoIndicatorView;
...
-(void)setupPlayerWithVideo:(id)video videoURL:(id)url preview:(id)preview force:(BOOL)force;
