...
@class VideoPlayerProgressStats, UIView, VKSession, VKMImageView, NSString, VKVideo, VideoStatsProvider, UILabel, UIButton, MPMoviePlayerController, TimerTarget, UIActivityIndicatorView, UIWebView;
