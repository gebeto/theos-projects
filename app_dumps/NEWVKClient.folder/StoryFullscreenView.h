...
@class UIView, StoryFullscreenProgressView, StoryFullscreenFooterView, StoryHighlightableSourceView, KVOObserver, VideoPlayerErrorOverlayView, UIButton, EmptyStateView, UIVisualEffectView, UIImageView, StoryVideoPlayerView, StoryFullscreenPhotoImageView;
