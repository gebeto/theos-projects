...
@class AFHTTPRequestOperation, NSString, NSIndexPath, ModelContext, NSNumber;
...
@interface LoadingModel : Model {
	...
	BOOL _cachedIndex;
	NSNumber* _owner;
	LoadingModel<SearchModel>* _searchModel;
	Class _searchLocal;
...
@property(retain, nonatomic) LoadingModel<SearchModel>* searchModel;
...
+(id)parseItems:(id)items class:(Class)aClass to:(id)to;
+(id)parseApps:(id)apps;
+(id)parseApps:(id)apps to:(id)to;
+(id)parseVideos:(id)videos;
+(id)parseVideos:(id)videos to:(id)to;
+(id)parsePhotos:(id)photos;
+(id)parsePhotos:(id)photos to:(id)to;
