...
@interface FriendsSelectorDataSource : VKSelectorModelDataSource {
	...
	id<VKSelectorOption> _friendOutcomingRequestsOption;
	id<VKSelectorOption> _followersOption;
	id<VKSelectorOption> _friendListsOption;
}
@property(readonly, assign, nonatomic) id<VKSelectorOption> friendListsOption;
@property(readonly, assign, nonatomic) id<VKSelectorOption> followersOption;
@property(readonly, assign, nonatomic) id<VKSelectorOption> friendOutcomingRequestsOption;
