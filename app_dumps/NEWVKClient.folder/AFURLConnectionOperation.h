...
@class NSString, NSSet, NSInputStream, NSData, NSHTTPURLResponse, NSURLResponse, NSOutputStream, NSMutableData, NSURLRequest, NSURLConnection, NSError, NSRecursiveLock;
