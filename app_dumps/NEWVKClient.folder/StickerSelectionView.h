...
@class UIView, NSString, StickersLoadingManager, StickerPopup, UIScrollView, UILabel, UICollectionView;
@protocol StickerSelectionViewDelegate, StickerSelectionViewPhotoEditorModeDelegate, StickerSelectionViewScrollingDelegate, StickerSelectionViewDataSource;
