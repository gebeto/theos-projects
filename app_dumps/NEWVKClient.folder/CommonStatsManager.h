...
-(void)discoverAction:(id)action;
-(void)clickNotification:(id)notification region:(int)region;
-(void)viewNotification:(id)notification;
...
-(void)openOwner:(id)owner ref:(id)ref;
...
-(void)navigateTarget:(id)target openDate:(id)date closeDate:(id)date3 ref:(id)ref;
